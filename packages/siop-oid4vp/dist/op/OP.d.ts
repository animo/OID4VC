...
import { AuthorizationResponseOpts, AuthorizationResponseWithCorrelationId, DcqlQueryResponseOpts, PresentationExchangeResponseOpts } from '../authorization-response';
